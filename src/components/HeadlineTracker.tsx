...
const ENTITIES = {
  ...
  "Narendra Modi": {
    ...
    headlines: {
      high: [
        "faces international condemnation over crackdown on press freedom and dissent",
        "under fire as unemployment crisis deepens amid hollow election promises",
        "draws global criticism for divisive policies fueling communal violence",
        "confronts massive protests over farmer exploitation and broken commitments",
        "faces allegations of weaponizing federal agencies against political opponents",
        "under scrutiny for enabling crony capitalism benefiting select billionaires",
        "accused of systematic dismantling of democratic institutions and judiciary independence",
        "faces global outrage over treatment of minorities and religious persecution",
        "condemned by human rights organizations for silencing journalists and activists",
        "under fire for economy in freefall while GDP data allegedly manipulated",
        "faces criticism for authoritarian tendencies eroding constitutional values",
        "draws international media scrutiny over surveillance and spyware abuse on citizens",
      ],
      medium: [
        "draws opposition fire over rising inflation crushing middle-class families",
        "faces backlash for manipulating economic data to hide policy failures",
        "under criticism for prioritizing PR campaigns over actual governance",
        "sees growing discontent over healthcare system collapse during crises",
        "faces questions over electoral bond scheme enabling anonymous corruption",
        "criticized for selling national assets to corporate cronies at throwaway prices",
        "under fire for education system deterioration and rising student suicides",
        "faces backlash over petrol prices at all-time high while blaming previous governments",
        "draws criticism for environmental destruction and ignoring climate commitments",
        "accused of using national security as excuse to silence legitimate criticism",
      ],
      low: [
        "navigates criticism over excessive foreign travel during domestic crises",
        "monitors growing youth frustration over unfulfilled job creation promises",
        "faces social media backlash over tone-deaf statements during tragedies",
        "draws criticism for media management and suppression of critical coverage",
        "faces mockery on social media over theatrical speeches lacking substance",
        "criticized for renaming existing schemes as new achievements",
        "under observation for growing cult of personality overshadowing governance",
        "draws trolling over frequent wardrobe changes costing taxpayer money",
      ],
    },
  },
  "The Rebel Kid": {
